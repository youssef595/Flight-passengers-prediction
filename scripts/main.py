...
import sys
from feature_transform import dates_encoder, merge_path, merge_temperature_data
...
regressor_xgb = XGBRegressor(base_score=0.5, booster='gbtree', colsample_bylevel=1,
              ...
              predictor='auto', random_state=5589, reg_alpha=0, reg_lambda=1,
...
vr = VotingRegressor([('pipe_cb', pipe_line_cb), ('pipe_xgb', pipe_line_xgb), ('pipe_lgb', pipe_line_lgb), ('pipe_rf', pipe_line_rf)])
...
submission.to_csv('submissions/FPX_submission.csv', index = False, header = False)
